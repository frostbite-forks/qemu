...
#ifndef HW_XBOX_NV20_PGRAPH_VK_RENDERER_H
#define HW_XBOX_NV20_PGRAPH_VK_RENDERER_H
...
typedef struct PipelineKey {
    ...
    uint32_t regs[9];
    VkVertexInputBindingDescription binding_descriptions[NV20_VERTEXSHADER_ATTRIBUTES];
    VkVertexInputAttributeDescription attribute_descriptions[NV20_VERTEXSHADER_ATTRIBUTES];
} PipelineKey;
...
typedef struct PGRAPHVkState {
    ...
    MemorySyncRequirement vertex_ram_buffer_syncs[NV20_VERTEXSHADER_ATTRIBUTES];
    size_t num_vertex_ram_buffer_syncs;
    unsigned long *uploaded_bitmap;
    size_t bitmap_size;

    VkVertexInputAttributeDescription vertex_attribute_descriptions[NV20_VERTEXSHADER_ATTRIBUTES];
    int vertex_attribute_to_description_location[NV20_VERTEXSHADER_ATTRIBUTES];
    int num_active_vertex_attribute_descriptions;

    VkVertexInputBindingDescription vertex_binding_descriptions[NV20_VERTEXSHADER_ATTRIBUTES];
    int num_active_vertex_binding_descriptions;
    hwaddr vertex_attribute_offsets[NV20_VERTEXSHADER_ATTRIBUTES];
    ...
    TextureBinding *texture_bindings[NV20_MAX_TEXTURES];
...
// buffer.c
void pgraph_vk_init_buffers(NV20State *d);
void pgraph_vk_finalize_buffers(NV20State *d);
...
// vertex.c
void pgraph_vk_bind_vertex_attributes(NV20State *d, unsigned int min_element,
                                      unsigned int max_element,
                                      bool inline_data,
                                      unsigned int inline_stride,
                                      unsigned int provoking_element);
void pgraph_vk_bind_vertex_attributes_inline(NV20State *d);
...
void pgraph_vk_bind_textures(NV20State *d);
void pgraph_vk_mark_textures_possibly_dirty(NV20State *d, hwaddr addr,
                                            hwaddr size);
...
void pgraph_vk_clear_report_value(NV20State *d);
void pgraph_vk_get_report(NV20State *d, uint32_t parameter);
void pgraph_vk_process_pending_reports(NV20State *d);
void pgraph_vk_process_pending_reports_internal(NV20State *d);
...
// blit.c
void pgraph_vk_image_blit(NV20State *d);

// gpuprops.c
void pgraph_vk_determine_gpu_properties(NV20State *d);
