...
void nv20_dbg_renderdoc_init(void)
{
    if (rdoc_api) {
        return;
    }
...
void *nv20_dbg_renderdoc_get_api(void)
{
    return (void*)rdoc_api;
}

bool nv20_dbg_renderdoc_available(void)
{
    return rdoc_api != NULL;
}

void nv20_dbg_renderdoc_capture_frames(int num_frames, bool trace)
{
