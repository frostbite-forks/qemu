...
void pgraph_gl_clear_surface(NV20State *d, uint32_t parameter)
{
    ...
    NV20_DPRINTF("Translated clear rect to %d,%d - %d,%d\n", xmin, ymin,
...
void pgraph_gl_draw_begin(NV20State *d)
{
    ...
    NV20_GL_DGROUP_BEGIN("NV097_SET_BEGIN_END: 0x%x", pg->primitive_mode);
...
void pgraph_gl_flush_draw(NV20State *d)
{
    ...
    if (pg->draw_arrays_length) {
        NV20_GL_DPRINTF(false, "Draw Arrays");
        ...
        NV20_GL_DPRINTF(false, "Inline Elements");
        ...
        for (int i = 0; i < NV20_VERTEXSHADER_ATTRIBUTES; i++) {
            ...
            if (attr->inline_buffer_populated) {
                nv20_profile_inc_counter(NV20_PROF_GEOM_BUFFER_UPDATE_3);
        ...
        NV20_GL_DPRINTF(false, "Inline Array");
        ...
        NV20_GL_DPRINTF(true, "EMPTY NV097_SET_BEGIN_END");
