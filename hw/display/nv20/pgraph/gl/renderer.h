...
#ifndef HW_XBOX_NV20_PGRAPH_GL_RENDERER_H
#define HW_XBOX_NV20_PGRAPH_GL_RENDERER_H
...
unsigned int pgraph_gl_bind_inline_array(NV20State *d);
void pgraph_gl_bind_shaders(PGRAPHState *pg);
void pgraph_gl_bind_textures(NV20State *d);
void pgraph_gl_bind_vertex_attributes(NV20State *d, unsigned int min_element, unsigned int max_element, bool inline_data, unsigned int inline_stride, unsigned int provoking_element);
...
void pgraph_gl_clear_report_value(NV20State *d);
void pgraph_gl_clear_surface(NV20State *d, uint32_t parameter);
void pgraph_gl_draw_begin(NV20State *d);
void pgraph_gl_draw_end(NV20State *d);
void pgraph_gl_flush_draw(NV20State *d);
void pgraph_gl_get_report(NV20State *d, uint32_t parameter);
void pgraph_gl_image_blit(NV20State *d);
void pgraph_gl_mark_textures_possibly_dirty(NV20State *d, hwaddr addr, hwaddr size);
void pgraph_gl_process_pending_reports(NV20State *d);
void pgraph_gl_surface_flush(NV20State *d);
void pgraph_gl_surface_update(NV20State *d, bool upload, bool color_write, bool zeta_write);
void pgraph_gl_sync(NV20State *d);
void pgraph_gl_update_entire_memory_buffer(NV20State *d);
void pgraph_gl_init_display(NV20State *d);
void pgraph_gl_finalize_display(PGRAPHState *pg);
void pgraph_gl_init_reports(NV20State *d);
...
void pgraph_gl_init_textures(NV20State *d);
void pgraph_gl_finalize_textures(PGRAPHState *pg);
void pgraph_gl_init_buffers(NV20State *d);
...
void pgraph_gl_render_surface_to_texture(NV20State *d, SurfaceBinding *surface, TextureBinding *texture, TextureShape *texture_shape, int texture_unit);
void pgraph_gl_set_surface_dirty(PGRAPHState *pg, bool color, bool zeta);
void pgraph_gl_surface_download_if_dirty(NV20State *d, SurfaceBinding *surface);
...
void pgraph_gl_surface_invalidate(NV20State *d, SurfaceBinding *e);
void pgraph_gl_unbind_surface(NV20State *d, bool color);
void pgraph_gl_upload_surface_data(NV20State *d, SurfaceBinding *surface, bool force);
...
int pgraph_gl_get_framebuffer_surface(NV20State *d);
